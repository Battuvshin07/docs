...
\begin{document}
	...
	\input{Chapters/AbstractPage.tex}
	...
	\listoftables
	\thispagestyle{fancy}
	\input{Chapters/PlanPage.tex}
	
	% Араб тоогоор дугаарлах хэсэг эхлэх (Удиртгал-аас)
	\newpage
	\pagenumbering{arabic}
	
	\input{Chapters/IntroductionPage.tex}
	\input{Chapters/TheoryPage.tex}
	\input{Chapters/MethodologyPage.tex}
	\input{Chapters/ImplementationPage.tex}
	\input{Chapters/TestingPage.tex}
	\input{Chapters/ConclusionPage.tex}
	\input{Chapters/ReferencesPage.tex}
